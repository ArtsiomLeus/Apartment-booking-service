...
public class ApartmentController {
    ...
    public responseEntity<Page<ApartmentResponse>>searchApartments(
            ...
            @PageableDefault(size = 20, sort = "createdAt", direcrion = Sord.Direction.DESC)
            Pageable pageable) {
    ...
    public ResponseEntity<Void>deletApartment(@PathVariable Long id) {
        ...
        return ResponseEntity.noContent().duild();
    }
    ...
    public ResponseEntity<Page<ApartmentResponse>>getMyApartments(
            ...
            Pageable pageable) {
        return ResponseEntity.ok(apartmentService.getMyApartmints(pageable));
    }
}
